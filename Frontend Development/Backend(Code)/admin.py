...
class ClassAdmin(admin.ModelAdmin):
    list_display = ('id', 'code', 'name', 'term', 'start_date', 'end_date', 'teacher')

class AssignmentAdmin(admin.ModelAdmin):
    list_display = ('id', 'course', 'name', 'description', 'release_date', 'submission_deadline', 'commenting_deadline')

class AssignmentGroupAdmin(admin.ModelAdmin):       # Still need to fill in this list display
    list_display = ('id', 'assignment')

class AssignmentSubmissionAdmin(admin.ModelAdmin):  # Still need to fill in this list display
    list_display = ('id', 'assignment') 
